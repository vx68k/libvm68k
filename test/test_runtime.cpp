...
private:
    ...
    void testReadWrite()
    {
        ...
        uint32_t value2 = 0;
        memory->write(memory_map::function_code::supervisor, 0x10000U, sizeof value1, &value1);
        memory->read(memory_map::function_code::supervisor, 0x10000U, sizeof value2, &value2);
...
private:
    void testRead()
    {
        ...
        _context->memory()->write(memory_map::function_code::supervisor, 0x8000U, 4U, bytes);
...
private:
    void testWrite()
    {
        ...
        _context->memory()->read(memory_map::function_code::supervisor, 0x8000U, 4U, bytes);
